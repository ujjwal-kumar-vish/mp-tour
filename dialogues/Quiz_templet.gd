...
onready var DisplayText = $TextureRect/Label
onready var ListItem = $TextureRect/ItemList
onready var RestartButton = $TextureRect/Button

var items : Array = read_json_file("dialogues/Questions.json")
var item : Dictionary
